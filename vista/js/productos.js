$(document).ready(function() {
    ...
    listarLosMasVendidos();
    listarLosRecienLLegados();

   
});

function listarLosMasVendidos() {
    $.post
            (
                    "../controlador/producto.listarLosMasVendidos.controller.php"
...
function listarLosRecienLLegados() {
    $.post
            (

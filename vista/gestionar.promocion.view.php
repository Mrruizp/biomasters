...
<html>
    ...
    <body class="hold-transition skin-purple-light sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                  <div class="container-fluid">
                    <div class="row mb-2">
                      <div class="col-sm-6">
                        <h1>Módulo Promoción</h1>
                      </div>
                      <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                          <li class="breadcrumb-item"><a href="menu.principal.view.php">Inicio</a></li>
                          <li class="breadcrumb-item active">Módulo Promoción</li>
                        </ol>
                      </div>
                    </div>
                  </div><!-- /.container-fluid -->
                          ...
                          <!-- form start -->
                            ...
                            <div class="card-body">
                              <div class="form-group">
                                <button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#myModal" id="btnagregar"><ion-icon name="cart"></ion-icon> Agregar Promoción</button>
                              </div>
                              <div class="form-group">
              ...
              <form  role="form" enctype="multipart/form-data" action="../controlador/promocion.registrar.controller.php"  class="form-horizontal" method="POST">
                <div class="modal fade" id="myModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header bg-info">
                        <h4 class="modal-title" id = "titulomodalDoctor">Registrar Promoción</h4>
                      ...
                      <div class="modal-body">
                        <div class="row">
                          ...
                          <div class="row">
                            <div class="col-6">
                              <input type="hidden" id="textCod_prom" name="textCod_prom">
                                <p>
                                ...
                                class="card-body d-flex justify-content-between align-items-center input-group">
                                    <label class="input-group-btn">
                                        <span class="btn btn-info">
                                           <i class="fa fa-camera"></i><input type="file" style="display: none;" multiple accept="image/png,image/jpeg,image/jpg" id="file-upload" name="file-upload">
                                        </span>
                                    </label>
        ...
        <script src="js/gestionarPromocion.js" type="text/javascript"></script>
